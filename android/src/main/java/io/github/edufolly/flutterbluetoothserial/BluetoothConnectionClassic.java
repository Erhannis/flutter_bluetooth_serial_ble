...
// This function is connecting bluetooth classic with -1 port, in new android devices.
//        socket =  device.createRfcommSocketToServiceRecord(DEFAULT_UUID);

//  Here we need to explicitly set port as 1, to work communication fluently in Android.
